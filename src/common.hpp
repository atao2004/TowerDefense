...
enum class TEXTURE_ASSET_ID
{
	...
	PLANT_2_IDLE_F = ARROW + 1,
	PLANT_2_IDLE_B = PLANT_2_IDLE_F + 1,
	PLANT_2_IDLE_L = PLANT_2_IDLE_B + 1,
	PLANT_2_IDLE_R = PLANT_2_IDLE_L  + 1,
	TEXTURE_COUNT = PLANT_2_IDLE_R + 1
};
...
const TEXTURE_ASSET_ID PLANT_2_IDLE_ANIMATION[] = {
    ...
    TEXTURE_ASSET_ID::PLANT_2_IDLE_L,
    TEXTURE_ASSET_ID::PLANT_2_IDLE_R
};
