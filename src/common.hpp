...
const TEXTURE_ASSET_ID PLANT_IDLE_ANIMATION[] = {
	TEXTURE_ASSET_ID::PLANT_2_IDLE_F,
	TEXTURE_ASSET_ID::PLANT_2_IDLE_B
};
...
const int PLANT_IDLE_SIZE = sizeof(PLANT_IDLE_ANIMATION) / sizeof(PLANT_IDLE_ANIMATION[0]);
...
const int PLANT_IDLE_DURATION = 2000;
