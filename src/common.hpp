...
const int SCORCHED_EARTH_WIDTH = (int) (CAMERA_VIEW_WIDTH * 0.75 / GRID_CELL_WIDTH_PX);
const int SCORCHED_EARTH_HEIGHT = (int) (CAMERA_VIEW_HEIGHT * 0.75 / GRID_CELL_HEIGHT_PX);
...
const TEXTURE_ASSET_ID PLANT_ATTACK_ANIMATION[] = {
	TEXTURE_ASSET_ID::PLANT_2_ATTACK_F1,
	TEXTURE_ASSET_ID::PLANT_2_ATTACK_F2,
	TEXTURE_ASSET_ID::PLANT_2_IDLE_F,
};
...
const int PLANT_ATTACK_SIZE = sizeof(PLANT_ATTACK_ANIMATION) / sizeof(PLANT_ATTACK_ANIMATION[0]);
