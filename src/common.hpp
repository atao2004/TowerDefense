...
enum class TEXTURE_ASSET_ID
{
	...
	TUTORIAL_ATTACK = TUTORIAL_MOVE + 1,
	TUTORIAL_PLANT = TUTORIAL_ATTACK + 1,
	TUTORIAL_RESTART = TUTORIAL_PLANT + 1,
	TOOLBAR = TUTORIAL_RESTART + 1,
	PAUSE = TOOLBAR + 1,
...
inline int TUTORIAL_HEIGHT_TILE_NUM = 10;
...
// const int PLAYER_RIGHT_BOUNDARY = WINDOW_WIDTH_PX - PLAYER_LEFT_BOUNDARY;
// const int PLAYER_UP_BOUNDARY = (PLAYER_HEIGHT / 2) + SCORCHED_EARTH_BOUNDARY;
// const int PLAYER_DOWN_BOUNDARY = WINDOW_HEIGHT_PX - PLAYER_UP_BOUNDARY;
const int PLAYER_LEFT_BOUNDARY = 0;
const int PLAYER_RIGHT_BOUNDARY = MAP_WIDTH_PX;
const int PLAYER_UP_BOUNDARY = 0;
const int PLAYER_DOWN_BOUNDARY = MAP_HEIGHT_PX;

const int PLAYER_RIGHT_BOUNDARY_TUTORIAL = TUTORIAL_WIDTH_PX;
const int PLAYER_DOWN_BOUNDARY_TUTORIAL = TUTORIAL_HEIGHT_PX;
