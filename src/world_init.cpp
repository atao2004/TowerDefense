...
Entity createZombieSpawn(RenderSystem* renderer, vec2 position) {
	...
	AnimationSystem::update_animation(entity, ZOMBIE_SPAWN_DURATION, ZOMBIE_SPAWN_ANIMATION, sizeof(ZOMBIE_SPAWN_ANIMATION) / sizeof(ZOMBIE_SPAWN_ANIMATION[0]), false, false, true);
...
Entity createZombie(RenderSystem* renderer, vec2 position) {
	...
	AnimationSystem::update_animation(entity, ZOMBIE_MOVE_DURATION, ZOMBIE_ANIMATION, sizeof(ZOMBIE_ANIMATION) / sizeof(ZOMBIE_ANIMATION[0]), true, false, false);
...
Entity createEffect(RenderSystem* renderer, vec2 position, vec2 scale) {
	...
	AnimationSystem::update_animation(entity, SLASH_DURATION, SLASH_ANIMATION, sizeof(SLASH_ANIMATION) / sizeof(SLASH_ANIMATION[0]), false, false, true);
