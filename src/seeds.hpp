...
SEED_MAP = {
    ...
    {1, seed(TEXTURE_ASSET_ID::SEED_3, PLANT_ID::PLANT_2)},
    {2, seed(TEXTURE_ASSET_ID::SEED_4, PLANT_ID::PLANT_3)},
    {3, seed(TEXTURE_ASSET_ID::SEED_1, PLANT_ID::PLANT_1)},
    {4, seed(TEXTURE_ASSET_ID::SEED_2, PLANT_ID::PLANT_1)},
